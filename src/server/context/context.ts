...
export type Context = Awaited<ReturnType<typeof createContext>> ;    // Instead of manually writing the conditional type, just use Awaited (built-in TS utility): This unwraps the promise and gives you the actual shape.This unwraps the promise and gives you the actual shape.
